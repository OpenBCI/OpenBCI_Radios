...
function OpenBCIFactory() {
     ...
     *                  of truth instead of local computer time. (Default `false`)
     *
    ...
    function OpenBCIBoard(options) {
        ...
        this.sntpOptions = {
            host: 'time.apple.com',  // Defaults to pool.ntp.org
     ...
     *      **Note**: This functionality requires OpenBCI Firmware Version 2.0
     * @since 1.0.0
     * @returns {Promise} - Resolves if `synced` event is emitted, rejects if not connected or using firmware verison +2.
     * @author AJ Keller (@pushtheworldllc)
     */
    OpenBCIBoard.prototype.syncClocksFull = function() {
        return new Promise((resolve,reject) => {
            ...
            }, 1000); // Should not take more than 500ms to sync up
