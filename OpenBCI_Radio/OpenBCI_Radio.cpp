...
*/
boolean OpenBCI_Radio::begin(uint8_t mode, int8_t channelNumber) {
...
* @author: AJ Keller (@pushtheworldllc)
*/
void OpenBCI_Radio::bufferSerialFetch(void) {
...
* @author: AJ Keller (@pushtheworldllc)
*/
void OpenBCI_Radio::configure(uint8_t mode, int8_t channelNumber) {
...
* @author: AJ Keller (@pushtheworldllc)
*/
boolean OpenBCI_Radio::readSerialDevice(void) {
...
* @author: AJ Keller (@pushtheworldllc)
*/
void OpenBCI_Radio::writeSerialDevice(void) {
...
/***************************************************/
void OpenBCI_Radio::_RFduinoGZLL_onReceive(device_t device, int rssi, char *data, int len) {

  // Is this the first packet we are receiving?
  if (bufferPacketsToReceive == 0) {
    bufferPacketsToReceive = data[0];
  }
